function countdown1(finalDate) {
    var dtDateInMilliseconds = Math.floor(finalDate - Date.now());

    var currentDelta = new DeltaDate(dtDateInMilliseconds);

    var $domSecond = $("#timerSeconds1").html(currentDelta.seconds);
    var $domMinute = $("#timerMinutes1").html(currentDelta.minutes);
    var $domHour = $("#timerHours1").html(currentDelta.hours);
    var $domDay = $("#timerDays1").html(currentDelta.days);
